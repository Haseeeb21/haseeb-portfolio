    ...
    <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
      <div className="max-w-4xl w-full">
        ...
        <p className="max-w-xl text-text-secondary leading-relaxed mb-10 font-sans text-base">
          <span className="text-accent-cyan">AI / ML Engineer</span> delivering enterprise-grade AI products.
          Presidential Gold Medalist with hands-on experience in Computer Vision, Machine Learning, NLP, and Generative AI.
